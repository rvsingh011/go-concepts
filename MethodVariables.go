...
// On line number 52. When I assign a function to a variable. It is a 2 word struct. 
// The first one is pointer to the actual function and the second one is a pointer to either 
// copy of the data or the refrence of the data based on the type of semantic which is at play here. 
